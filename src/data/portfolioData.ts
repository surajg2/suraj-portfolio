...
export const PORTFOLIO_DATA = {
  profile: {
    ...
    location: "India",
    expertise: ["Data Analysis", "Data Engineering", "SQL & ETL Pipelines", "Business Intelligence", "Python Analytics"],
    learning: "Advanced Data Engineering & Analytics Pipelines",
    github: "https://github.com/surajgupta",
  ...
  coreStack: [
    ...
    { name: "Streamlit", category: "Data Science", icon: "https://img.icons8.com/?size=100&id=w9gsKSM38X2h&format=png&color=000000" },
    { name: "Docker", category: "DevOps", icon: "https://skillicons.dev/icons?i=docker&theme=light" },
    { name: "Git", category: "Tools", icon: "https://skillicons.dev/icons?i=git&theme=light" },
